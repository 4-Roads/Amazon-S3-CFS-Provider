...
namespace Telligent.Extensions.AmazonS3
{
    ...
    public class Connection
    {
        ...
        public ObjectListResponse ListBucket( string bucket, string prefix, string marker,
        ...
        {
            return HttpUtility.UrlEncode(key, System.Text.Encoding.UTF8).Replace("%2f", "/");
        }
        ...
        /// </summary>
        private WebRequest makeRequest(string method, string bucket, string key, SortedList headers, SortedList metadata)
        {
            return makeRequest(method, bucket, key, new SortedList(), headers, metadata);
        }
